...
function createLoginButton(){
    return `<button type="button" id="login-btn" class="btn myText myNavItem myLogin" data-toggle="modal" data-target="#loginModal">           
    <span>
...
function createLogOutButton(){
    return `<button type="button" id="logout-btn" class="btn myText myNavItem myLogin">           
    <span>
