...
val mainClassName = "Mobile"

// Define the main class for the application.
application.mainClass = "$group.iot.mobile.$mainClassName"

val jarBaseName = "mobile"
...
tasks {
	...
	jar {
		...
		println("[GRADLE] INFO created jar file. Execute \"java -jar $appJar <phoneNumber> <true|false>\"")
	}
